...
namespace students
{
    ...
    internal class Program
    {
        ...
        startprogram:
            ...
            Console.Clear();
            Console.WriteLine(" F1: Manage Student   F2:Manage Course   F3:Manage Score    // console first line                                    F10:Exit Program");
        Keyspart:
        ...
        static void consolecustomlayout()    // console custom change color,font size , set window size
        {
            ...
            Console.SetWindowSize(116, 30); // set the window size to 116 column and 30 rows
